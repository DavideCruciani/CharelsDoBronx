...
const Navbar = ({Logo}: NavbarProps) => {
  ...
  return (
    <nav className="bg-transparent fixed z-[999] right-0 top-0 left-0 p-5 flex justify-between font-Lakki">
      ...
      <div className={nav ? 'fixed bg-green-700 border-l-2 border-l-green-800 flex justify-center py-32 xl:hidden right-0 top-0 text-center p-4 w-2/3 h-full ease-in-out duration-300' : 'fixed border-l-2 border-l-green-800 flex justify-center py-32 xl:hidden top-0 text-center p-4 w-2/3 h-full right-[-100%] ease-in-out duration-300'}>
