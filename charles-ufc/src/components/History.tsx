      ...
      <div className="container mx-auto px-5 text-center">
        <div className="flex flex-col-reverse justify-center items-center lg:flex-row  w-full pb-10 pt-20">
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center p-4">
            <h2 className="text-yellow-400 font-Lakki xl:text-9xl sm:text-8xl text-7xl">From Nothing...</h2>
          </div>
        </div>
        <div className="flex w-full flex-col lg:flex-row justify-center items-center py-10">
          <div className="w-full lg:w-1/2 flex items-center justify-center p-4">
            <h2 className="text-yellow-400 font-Lakki xl:text-9xl sm:text-8xl text-7xl">To Something...</h2>
          </div>
          <div className="w-full lg:w-1/2">
        ...
        <div className="flex w-full flex-col-reverse lg:flex-row justify-center items-center pt-10 pb-20">
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center p-4">
            <h2 className="text-yellow-400 font-Lakki xl:text-9xl sm:text-8xl text-7xl">To Everything</h2>
          </div>
        </div>
      </div>
    </section>
